---
title: 和 lvgo 一起学设计模式（零）序
id: learn-design-patterns-with-lvgo
tags: 设计模式
categories: 设计模式
excerpt: 　　"设计模式是一个非常重要的知识点，其中包含着大量的一名“合格”的程序员所需要的基本功，包括软件设计原则、UML类图读画、软件实体关系理解、程序健壮维护等等等等，快来和我一起学习吧。希望能够和你一起进步，一起学习技术，为了梦想。干杯🍻"
comments: true
abbrlink: 34779
date: 2020-10-05 18:29:31
---
...
- [x] [2. 原型模式：啥？盗图、盗文章的人居然用的是一种设计模式！叫原型模式？](https://github.com/lvgocc/java-design-patterns/tree/main/prototype)
...
- 3️⃣ 依赖倒置原则 DIP ，1996 年 Object Mentor 公司总裁罗伯特·马丁（Robert C.Martin）🧑在 [C++](http://c.biancheng.net/cplus/) Report 上发表的文章 ：高层模块不应该依赖低层模块，两者都应该依赖其抽象；抽象不应该依赖细节，细节应该依赖抽象 （<u>要面向接口编程，不要面向实现编程。</u>）
...
我希望用一些不同的颜色背景来区分那些我们常用而且必须熟知的一些模式。
