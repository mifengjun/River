---
title: 建造者模式：学个设计模式还和人生扯上关系了？
id: lvgo-design-patterns-build
tags: 设计模式
categories: 设计模式
banner: https://i.loli.net/2020/10/17/8NsSJTuzyraGeOV.png
excerpt: 　　“相同的资源，不同的结果是我对建造者模式创建对象的理解。就像建造我们的人生，提供了相同的世界，相同的空气，每个个体的表现均不同。”
comments: true
abbrlink: 698
date: 2020-10-18 01:13:22
---
