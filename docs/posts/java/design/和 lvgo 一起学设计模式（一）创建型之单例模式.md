---
title: 单例模式：资源, 要合理的分配使用！
id: lvgo-design-patterns-singleton
tags: 设计模式
categories: 设计模式
excerpt: 单例模式，老生常谈的一种设计模式，你还记得吗？快来和我一起学习（复习）吧。一起学习技术，为了梦想。干杯🍻”
comments: true
abbrlink: 34020
date: 2020-10-06 17:48:52
---
...
![单例模式结构类图 https://lvgocc.github.io](../images/posts/design-pattern/singleton/singleton.png)
...
老爷子的github ：[https://github.com/jbloch](https://github.com/jbloch)
